...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'kraftbouquet_20220602_1a0dc1ede8acb52a8495_20230930172835_archive.zip';
	const ARCHIVE_SIZE		 = '148047387';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1a0dc1e-30172835';
    const SECONDARY_PACKAGE_HASH = '557d788-30172835';
	const VERSION			 = '1.4.7';
